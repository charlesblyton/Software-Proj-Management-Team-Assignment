...
public class Value {
    ...
    public Value(String id, String startTime, String completionTime, String email, String name, String fnameLname, String studentID, String workshopClass, String preferableTeammates, String projectOption, String ITlanguage, String timezone, String preferableDays, String preferableTime ) {
        this.id                  = id;
